            ...
            <x-header :left-options="{showBack: false}" style="height: 54px; background-color: rgba(255, 255, 255, 0)">
              ...
              <div>
                <popover placement="bottom" style="margin:0px;">
                  <div slot="content" class="popover-demo-content">
                    <div v-for="ship in shipList" >
                      <x-button @click.native="confirmShow(ship)" style="padding:10px 20px 10px 20px; border-style: none;">{{ship.name}}</x-button>
                      <hr>
                    </div>
                  </div>
                  <x-button class="btn btn-default" style="background-color: rgba(0, 0, 0, 0);font-size:20px;border-style:hidden;color:white">{{headerTop}}</x-button>
                ...
                <popover placement="bottom" style="margin:0px;">
                  ...
                  <button  class="my-btn vux-header-right"><i style="opacity:0;color:white;font-size:20px " class="el-icon-view"></i></button>
                </popover>
              </div>
            </x-header>
            <div class="view">
